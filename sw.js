...
const FILES_TO_CACHE = [
  ...
  './js/notes.js',
  './js/overtime.js',
  './js/github-token-manager.js',
  './js/onevr-popup.js',
  './js/ui-github-token.js',
  './js/firebase-localStorage-sync.js',
  './js/pull-to-refresh.js',
  './js/app.js',
  // Assets
  './icon.png',
  './manifest.json',
  // Documents (PDF) — lazy-cached on first open, not precached
